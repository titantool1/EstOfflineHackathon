...
class ConditionContextControllerTest {
    ...
    @Test void memberContextOwnsTheLookupAndPreservesRequestId() throws Exception {
        ...
        mvc.perform(get("/api/profile/condition-context").requestAttr(ConditionContextController.CURRENT_USER_ID, OWNER)
    ...
    @Test void invalidMemberContextAndInvalidSelectionDoNotQuery() throws Exception {
        mvc.perform(get("/api/profile/condition-context").requestAttr(ConditionContextController.CURRENT_USER_ID, "not-a-uuid")
