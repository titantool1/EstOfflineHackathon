...
export function ProfilePreferences() {
  ...
  return <div className="mt-8 grid items-start gap-6 lg:grid-cols-[1.05fr_1fr]">
    <section className="rounded-3xl bg-white p-7 shadow-sm ring-1 ring-[#dcebd5]">
      <div className="flex items-center justify-between gap-4"><h2 className="text-2xl font-bold text-[#1e5831]">관심사</h2><Link href="/onboarding?mode=edit" className="inline-flex min-h-11 items-center text-sm font-bold text-[#4e9e47]">{data?.interests?.length === 0 ? "설정" : "수정"}</Link></div>
