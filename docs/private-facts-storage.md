...
1. 적용할 릴리스의 migration 목록을 확인한다. 이 브랜치는 기존 V1/V2/V3/V5에 V8/V9/V10을 추가한다. 별도 미션 작업의 V4/V6/V7을 배포할 예정이면 먼저 함께 통합한다. 이미 상위 버전이 적용된 DB에 낮은 번호를 나중에 추가하지 않는다.
